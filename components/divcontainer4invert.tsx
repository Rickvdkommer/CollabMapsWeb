...
const DivcontainerWithImage: NextPage = () => {
  return (
    <div className="mx-auto md:pt-[10rem] max-w-6xl border-box w-full flex flex-col items-center justify-start py-[2.06rem] gap-[4rem] z-[1] mt-[-0.75rem] text-center text-[2.75rem] sm:text-[3.5rem] lg:text-[4.53rem] text-high-contrast-dark font-poppins">
      <div className="flex flex-col items-start justify-start py-0 sm:flex-row">
        <div className="order-2 sm:order-1 flex-1 flex flex-col items-center justify-start gap-3 sm:px-4 overflow-hidden">
